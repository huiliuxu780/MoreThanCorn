...
## 更新摘要
**变更内容**
- 新增 Agent 发布对话框组件，支持版本创建和环境部署（沙箱/线上）
- 增强 Agent 编辑器，集成版本管理和发布状态显示
- 改进工作流设计器，支持按 editor_kinds 过滤节点目录
- 新增 API 方法：createVersion、release、versions、releases 用于版本创建和发布管理
- 实现 Agent 级版本徽标和环境部署状态展示

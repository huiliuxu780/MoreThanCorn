...
- **新增**：记录了 agent-ops-panels.tsx 和 app-shell.tsx 中使用 shadcn/ui Select 组件替换原生 select 元素的标准化过程
...
### 改造范围与影响
- **工作流设计器**：wf-designer.tsx 中的布尔值配置使用 Switch 替代原生 checkbox，Agent 选择使用 Select
- **Agent 公共配置**：agent-common-config.tsx 中的数据类型选择使用 Select，对话体验开关使用 Switch
- **Agent 操作面板**：agent-ops-panels.tsx 中的评测模式选择使用 Select，确保视觉一致性
- **应用外壳**：app-shell.tsx 中的角色切换使用 Select 组件，提升可访问性
...
#### Agent 操作面板中的 Select 使用
```tsx
// agent-ops-panels.tsx 中的评测模式选择
...
- [src/components/agent-common-config.tsx:1-84](file://src/components/agent-common-config.tsx#L1-84)
- [src/components/agent-ops-panels.tsx:1-289](file://src/components/agent-ops-panels.tsx#L1-289)
- [src/components/app/app-shell.tsx:1-205](file://src/components/app/app-shell.tsx#L1-205)
- [src/pages/wf-designer.tsx:850-1049](file://src/pages/wf-designer.tsx#L850-L1049)
- [src/pages/data-definition-editor.tsx:1-121](file://src/pages/data-definition-editor.tsx#L1-L121)
- [src/pages/wf-connections.tsx:1-271](file://src/pages/wf-connections.tsx#L1-L271)
- [src/components/tasks/task-form-sections.tsx:290-476](file://src/components/tasks/task-form-sections.tsx#L290-L476)
...
- 主题与组件库
  ...
  - **新增**：所有 Select 组件必须包含适当的 placeholder 和 aria-label 属性以提升可访问性。

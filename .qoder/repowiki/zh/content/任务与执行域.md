...
## 更新摘要
**所做更改**
- 增强了批处理功能，新增日期范围过滤支持，确保数据窗口在批量运行时真正生效
- 改进了质量评价系统的前端集成，支持真实数据源和人工证据添加
- 新增了Evidence模型和相关API接口，支持人工证据记录和管理
- 实现了双通道事件架构（CONTROL/CONTENT），增强可观测性和追踪能力
- 完善了Run执行生命周期管理，包括重试、取消和详细追踪查看
- **新增**：完整的span树构建逻辑，支持Run → NodeRun → CallRecord的层级关系展示
- **新增**：详细的token使用和性能指标统计，包含延迟、token消耗等关键指标
...
**最新更新**：系统已全面增强任务管理和执行功能，实现了真实的后端API集成，包括任务状态管理、Run重试和取消机制、人工证据添加等功能，为生产环境提供了完整的任务生命周期管理能力。**特别增强了运行追踪系统，新增了完整的span树构建逻辑，支持Run → NodeRun → CallRecord的层级关系展示，以及详细的token使用和性能指标统计。**
...
RUN->>DB : 写 CallRecord (tool/model/mcp/knowledge调用)
...
- [server/app/runner.py:638-679](file://server/app/runner.py#L638-679)
- [server/app/runner.py:437-572](file://server/app/runner.py#L437-572)
...
**章节来源**
- [server/app/models.py:366-382](file://server/app/models.py#L366-382)
- [server/app/models.py:179-232](file://server/app/models.py#L179-232)
- [server/app/models.py:282-315](file://server/app/models.py#L282-315)
- [server/app/models.py:330-344](file://server/app/models.py#L330-344)
...
**图表来源**
- [server/app/runner.py:437-572](file://server/app/runner.py#L437-572)
- [server/app/routers/runs.py:59-67](file://server/app/routers/runs.py#L59-67)
...
**章节来源**
- [server/app/runner.py:39-47](file://server/app/runner.py#L39-47)
- [server/app/runner.py:305-328](file://server/app/runner.py#L305-328)
- [server/app/routers/business.py:53-69](file://server/app/routers/business.py#L53-69)
...
- **智能时间字段识别**：根据 DataDefinition 中的 time_field 配置动态确定时间字段名
- **精确时间范围过滤**：支持 start 和 end 参数的精确时间范围匹配
- **默认时间字段**：当未配置 time_field 时，默认使用 interactionTime 字段

批处理函数 `batch_run_task` 现在能够正确处理日期窗口参数，确保只有符合时间范围的记录才会被处理。
...
**章节来源**
- [server/app/routers/business.py:285-318](file://server/app/routers/business.py#L285-L318)
- [server/app/models.py:508-521](file://server/app/models.py#L508-L521)
...
**章节来源**
- [server/app/routers/business.py:303-328](file://server/app/routers/business.py#L303-328)
- [src/pages/task-wizard.tsx:124-152](file://src/pages/task-wizard.tsx#L124-L152)
- [src/services/wf-api.ts:507-518](file://src/services/wf-api.ts#L507-L518)
...
**章节来源**
- [server/app/routers/runs.py:59-105](file://server/app/routers/runs.py#L59-105)
- [src/pages/run-detail.tsx:413-461](file://src/pages/run-detail.tsx#L413-461)
...
**章节来源**
- [server/app/models.py:357-368](file://server/app/models.py#L357-368)
- [server/app/routers/business.py:175-191](file://server/app/routers/business.py#L175-191)
...
**章节来源**
- [server/app/runner.py:49-67](file://server/app/runner.py#L49-67)
- [server/app/models.py:221-239](file://server/app/models.py#L221-239)
- [server/app/models.py:254-268](file://server/app/models.py#L254-268)
...
**章节来源**
- [server/app/runner.py:53-67](file://server/app/runner.py#L53-67)
...
**图表来源**
- [server/app/runner.py:638-679](file://server/app/runner.py#L638-679)
- [server/app/routers/workflows.py:110-134](file://server/app/routers/workflows.py#L110-134)
...
- [src/services/wf-api.ts:352-375](file://src/services/wf-api.ts#L352-375)
- [src/services/wf-api.ts:316-343](file://src/services/wf-api.ts#L316-343)
...
**章节来源**
- [server/tests/test_phase_c.py:50-73](file://server/tests/test_phase_c.py#L50-73)
- [server/tests/test_phase_c.py:76-91](file://server/tests/test_phase_c.py#L76-91)
- [server/tests/test_phase_c.py:94-142](file://server/tests/test_phase_c.py#L94-142)
...
## 更新摘要
**所做更改**
- 增强了任务管理API（PUT /api/tasks/{tid}、POST /api/tasks/{tid}/status）实现真实后端操作
- 改进了任务创建向导使用真实API替代前端占位逻辑
- Run执行功能增强（重试、取消、追踪查看）提供完整生命周期管理
- 质量评价系统的前端集成改进，支持真实数据源和人工证据添加
- 新增Evidence模型支持人工证据记录和管理
...
**最新更新**：系统已全面增强任务管理和执行功能，实现了真实的后端API集成，包括任务状态管理、Run重试和取消机制、人工证据添加等功能，为生产环境提供了完整的任务生命周期管理能力。
...
- [src/pages/task-wizard.tsx:124-152](file://src/pages/task-wizard.tsx#L124-152)
- [src/services/wf-api.ts:507-518](file://src/services/wf-api.ts#L507-518)
...
- [src/services/wf-api.ts:192-198](file://src/services/wf-api.ts#L192-198)
...
- [src/pages/quality-results.tsx:46-61](file://src/pages/quality-results.tsx#L46-61)
- [src/services/wf-api.ts:398-451](file://src/services/wf-api.ts#L398-451)
...
- [src/pages/result-rule-editor.tsx:40-283](file://src/pages/result-rule-editor.tsx#L40-283)

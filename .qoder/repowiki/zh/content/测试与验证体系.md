...
## 更新摘要
**变更内容**
- 新增 Vitest 前端单元测试框架集成，提供快速、现代的 JavaScript/TypeScript 测试能力
- 实现 7 个纯函数测试用例，覆盖列表过滤和排序逻辑的核心功能
- 增强测试基础设施，支持覆盖率报告和完整的测试生命周期管理
- 建立前后端统一的测试策略，提升代码质量和回归测试效率
...
- [src/lib/list-filters.test.ts:1-20](file://src/lib/list-filters.test.ts#L1-L20)
- [src/pages/wf-agents-list.test.ts:1-19](file://src/pages/wf-agents-list.test.ts#L1-L19)
- [src/lib/list-filters.ts:7-25](file://src/lib/list-filters.ts#L7-L25)
- [src/pages/wf-agents-list.tsx:27-32](file://src/pages/wf-agents-list.tsx#L27-L32)